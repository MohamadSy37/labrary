...
<main>
  ...
  <section>
      <h1>Exchange</h1>
      <center><a href="addex.php"><button class="btn">add book</button></a></center>
    ...
    <?php
      ...
      <div class="card">
         ...
         <div class="content">
            ...
            <div class="btn">
               <a href="chat.php?rn=<?php echo$row['id'];?>"><button>chat <i class="fa-solid fa-comment"></i></button></a><!--تبديل أيقونة الشات-->
            </div>
         </div>
      </div>
      <?php
