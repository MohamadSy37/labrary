...
<main>
    <div class="section">
    <form action="../../asset/php/addrent.php" method="post"  enctype="multipart/form-data">
        <div class="books">
        <div class="booksadd">
            <div class="inpt">

            <div class="rel">
            <label for="Books">Image</label>
            ...
            <div class="inpt">
                <div class="rel">
                <label for="Books">Name Books</label>
                <input type="text" name="name" id="">
            </div>
            <div class="rel">
            <label for="Books">Name clirck</label>
            <input type="text" name="nameclerk" id="">
        </div>
            </div>
            <div class="inpt">
                <div class="rel">
                <label for="Books">Email</label>
            ...
            <div class="inpt">
                <div class="rel">
                <label for="Books">Number Page</label>
                <input type="number" name="page" id="">
            </div>
            <div class="rel">
            <label for="Books">Price for day</label>
            ...
            <div class="inpt">
                ...
                <div class="inpt">
                    <input type="submit" name="rentbook" value="ADD">
                    </div>
        </div>
        </div>
