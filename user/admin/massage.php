...
?>
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          <?php
                                      $user=mysqli_query($con,"SELECT * FROM massage WHERE 1");
                                      while($alluser=mysqli_fetch_array($user)){
                                        ?>
            <div class="massage">
              <h1><?php echo$alluser['email'];?></h1>
              <h5><?php echo$alluser['data'];?></h5>
              <h5><?php echo$alluser['time'];?></h5>
              <p><?php echo$alluser['massage'];?></p>
            </div>
                                        <?php
                                      }?>
          </div>
