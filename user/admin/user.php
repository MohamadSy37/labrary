        ...
        <div class="recent-sales box">
          ...
          <div class="sales-details">
            <ul class="details">
              ...
              <?php
              $user=mysqli_query($con,"SELECT * FROM usertable WHERE id!='$_SESSION[user_id]'");
              while($alluser=mysqli_fetch_array($user)){
            ?>
              <li><a href="#"><?php echo$alluser['username'];?></a></li>
              <?php
              }?>
            </ul>
            <ul class="details">
              ...
              while($alluser=mysqli_fetch_array($user)){
            ?>
              <li><a href="#"><?php echo$alluser['email'];?></a></li>
              <?php
              }?>
            </ul>
            <ul class="details">
            <li class="topic">Phone</li>
              ...
              while($alluser=mysqli_fetch_array($user)){
            ?>
              <li><a href="#"><?php echo$alluser['phon'];?></a></li>
              <?php
              }?>
          </ul>
          <ul class="details">
            <li class="topic">gender</li>
              ...
              while($alluser=mysqli_fetch_array($user)){
            ?>
              <li><a href="#"><?php echo$alluser['gander'];?></a></li>
              <?php
              }?>
          </ul>
          <ul class="details">
            <li class="topic">Data join</li>
              <?php
              $user=mysqli_query($con,"SELECT * FROM usertable WHERE id!='$_SESSION[user_id]'");
              while($alluser=mysqli_fetch_array($user)){
            ?>
              <li><a href="#"><?php echo$alluser['data'];?></a></li>
              <?php
              }?>
          </ul>
          <ul class="details">
            <li class="topic">Time join</li>
              <?php
              $user=mysqli_query($con,"SELECT * FROM usertable WHERE id!='$_SESSION[user_id]'");
              while($alluser=mysqli_fetch_array($user)){
            ?>
              <li><a href="#"><?php echo$alluser['time'];?></a></li>
              <?php
              }?>
          </ul>
          </ul>
